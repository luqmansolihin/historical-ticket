        ...
        <div class="p-6 sm:p-8 space-y-6 bg-slate-900">
            ...
            <div class="grid grid-cols-2 gap-4 bg-slate-950/60 p-5 rounded-2xl border border-slate-800">
                <div>
                    ...
                    <span class="text-base font-semibold text-white mt-0.5 block">{{ $ticket->passenger_name }}</span>
                </div>
                <div>
            ...
            <div class="grid grid-cols-2 gap-4 bg-slate-950/60 p-5 rounded-2xl border border-slate-800">
                <div>
                    ...
                    <span class="text-sm font-medium text-slate-200 mt-0.5 block">{{ $ticket->booked_by }}</span>
                </div>
                <div>
                    <span class="text-xs text-slate-400 block">Siapa yang Bayar</span>
                    <span class="text-sm font-medium text-slate-200 mt-0.5 block">{{ $ticket->paid_by }}</span>
                </div>
                <div>
